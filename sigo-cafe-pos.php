	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
              ...
              <div id="contentWrapper ">
				<div class="page-title1 title-1 cafepose">
					<div class="container">
						<div class="row ">
							<div class="cell-12  padd-adj center">
								<h1 class="fx white" data-animate="fadeInLeft">Sigo Cafe Pos<span></span></h1>
								<!-- <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Technologies</span>
								</div> -->
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									<i class="fa"><img alt="Image" src="images/cup.png"  style="margin-top:-7px;"></i>
									<h4>Sigo Cafe Pos</h4>
									<br>
									<p class="mediumFont">SigoCafe Pos is one of the most popular Tablet-based POS systems for restaurants. It caters to both quick service and full-service restaurants. SigoCafe Pos caters not only to restaurants but also to cafes, pizza parlours, nightclubs, bakeries and more. POS systems provide a platform that is the heart of restaurants; enhances customer experience and streamlining your operations.</p>
				...
				<div class="sectionWrapper ">
					<div class="container">
								...
								<h3><span style="font-weight: bold; color: #a80306;padding-left:1%;">Why</span> Sigo Cafe Pos ?</h3><br>
							</div>
                            <div class="cell-6 service-box-3 fx  padd-adj" data-animate="fadeInLeft">
							
							<div class="clearfix"></div>
							
						
						    
							<p class="hint hintMargin align">SigoCafePos gives your staff mobility which increases staff efficiency and reducing chances of error. Keeping them armed at all time they are able to take the complex order and send them within seconds with the restaurant POS system. Pictures of the menu items can be shown to customers at their tables which will reduce chances of error and save time spent running back and forth between tables. Staff has the facility to add and edit customers, as well as products. Sigo CafePos provides complete history of orders and also cancel the order facility is also available. Sigo Cafe Pos is a complete restaurant management software designed to make the process of managing your restaurant not just easy, but entertaining as well. It not only helps in providing a wonderful dining experience to your customers but also makes the life of you and your customers a whole lot easier. The customers get to access the menu and place their order without having to wait for the steward. For easy navigation, the digital/eMenu lists the dishes using images, ingredients, and nutritional values under separate categories. To make the dining experience memorable, the customers are provided with the ability to customize the dishes with modifiers to meet their individual taste. Our future-ready restaurant management software is designed to keep track of everything that goes inside your restaurant, and everything is permission based to avoid theft.</p>
									<a href="Product-Brochure/Sigo Tablet based POS.pdf" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download PDF"></a>
									<!--<a href="download_pos.php" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download APK"></a>-->
                                    <a href="https://play.google.com/store/apps/details?id=com.sigosoft.possigosoft" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Get APK"></a>

							</div>
							
							
							 <div class="cell-6 service-box-3 fx  padd-adj" data-animate="fadeInRight">
							
						
							<img alt="Image" src="images/cafe.jpg">
                ...
                <div class="fun-staff staff-2 block-bg-4 sectionWrapper black-overlay">
					<div class="container">
                      ...
                      <p style="color:#fff;">It takes less than a minute of your time.<br>
Or you may simply <span style="font-size:16px !important; font-weight: 700;"><a href="tel:+91- 9846 23 73 84">call +91- 9846 23 73 84</a>
	<span></p>
                        </div>

                         <div class="cell-3">            
                       <a class="btn main-bg ExtraLargeBtn" href="quote.php">GET A QUOTE</a>
                        </div>
