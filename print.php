             ...
             <div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Print & Media<span></span></h1>
						...
						<div class="row">
							<div class="cell-6 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class="mediumFont">There may be scores of design houses who produce slick company brochures. However, our expertise lies in detailing and fine-tuning every page, every printed word and image of the final product. During brochure design, we ensure that every element ties in with the brand story that you want to tell. So every inch of this marketing collateral bears a stamp of your company.
							...
							<div class="cell-6 service-box-2 fx" data-animate="fadeInDown" data-animation-delay="200">
								<div class="box-2-cont">
									...
									<h4>Leaflet</h4>
									<div class="center sub-title main-color">sub title</div>
									<p class="mediumFont">A leaflet is a single page, printed on one or both sides, usually used to circulate in large numbers. Hence, it's printed on thin paper with lots of graphic for a better visual connectivity. Leaflets are used for basic level communication.Most leaflets are free, part of their purpose being to attract an audience or customers, or to spread specific information or propaganda.</p>
									<a class="r-more main-color" href="#">Read More</a>
								</div>
							</div>
				...
				<div class="sectionWrapper img-pattern">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Print & Media</h3>
									<p>Print media advertising is a form of advertising that uses physically printed media, such as magazines and newspapers, to reach consumers, business customers and prospects. Advertisers also use digital media, such as banner ads, mobile advertising, and advertising in social media, to reach the same target audiences.</p>
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="" src="images/print&media.png">
						</div>
					</div>
				</div>
					...
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Attractive">Logo Designing</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Effective">Corporate Vidios</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="User interface">Creative Designing</span></h4>
							</div>
							<div class="clearfix"></div>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Professional">Animation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
