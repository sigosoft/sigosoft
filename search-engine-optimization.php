	...
	<body>
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 seo2">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Search Engine Optimization<span></span></h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="index.php">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Services</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<div class="center sub-title main-color">SEO</div>
									<p class="mediumFont">The search engine optimization is a methodology of strategies, techniques and tactics which helps search engines find and rank a website higher than the millions of other websites in responding to a search query. Sigosoft Pvt Ltd provides SEO services which help your business to grow into greater peaks. We approach the search engine optimization (SEO) process in a highly meticulous method, according to your business requirements. There is no “One Size Fits All’ solution that works for everyone. Knowing which strategies to apply at right time, and how to apply them for every business is crucial.</p>
									<!-- <a class="r-more main-color" href="#">Read More</a> -->
								</div>
							</div>
							<!-- <div class="cell-6 service-box-2 fx" data-animate="fadeInDown" data-animation-delay="200">
								<div class="box-2-cont">
									<i class="fa fa-thumbs-o-up"></i>
									<h4>SMO</h4>
									<div class="center sub-title main-color">sub title</div>
									<p class="mediumFont">Social media optimization (SMO) is a form of internet marketing where one can generate publicity through social media. The SMO process helps content get more widely distributed through social media networks. Like SEO, SMO can be divided into on-page and off-page optimization. On-page social media optimization includes activities such as optimizing content, titles and code so that the on-page content can be easily accessed and distributed. Off-page SMO activities include building mashups and incoming links, thus helping the web property hosting the social media application become more popular on the internet.</p>
									<!-- <a class="r-more main-color" href="#">Read More</a> -->
								<!-- </div>
							</div> --> 
				...
				<div class="sectionWrapper img-pattern shadow">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of SEO</h3>
									<!-- <p> SMO are two terms have gotten very popular these days. The terms are mainly used in context for webmasters and bloggers. Both, SEO and SMO are utilized to increase traffic to a website. However, SEO and SMO are quite different than each other and utilize different techniques to achieve their means. There are many webmasters who claim expertise in SEO and/or SMO. Their main responsibility is to increase the number of visitors to a particular website.</p> -->
									<ul class="list prim list-ok ">
										<li class="fa fa-check">Better Online Presence</li><br>
										<li class="fa fa-check">Better User Experience</li><br>
										<li class="fa fa-check">Better ROI</li><br>
										<li class="fa fa-check">High Quality Back Links</li>
									</ul> 
								</div>
							</div>
						</div>
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="Image" src="images/seo.png" class="">
						</div>
					</div>
				</div>
				...
				<div class="sectionWrapper">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								<i class="icon main-bg fa fa-bullhorn"></i>
								<h4 class="main-color"><span data-hover="Social Media Marketing">Social Media Marketing</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Social media marketing (SMM) is a form of internet marketing where one can generate publicity through social media. The SMO process helps content get more widely distributed through social media networks. Social media creates a rostrum for you to get connected with as many people all over the world. <!-- Being one of the leading SMM Company in Calicut, Sigosoft realise the importance of such connections. Our ultimate aim is to use social media marketing in an effective manner take advantage of the many benefits that come with it. --></p>
							<a class="r-more main-color" href="social-media-marketing.php">Read More</a>
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa fa-desktop"></i>
								<h4 class="main-color"><span data-hover="Creative Design">Creative Design</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Sigosoft’s Creative Design works in areas of Branding, identity creation to various entities such as product labels or brochures, that provide information about a company’s offerings and services. we design these materials using paper sketches and digital illustration software. <!-- We will follow the process from concept to rough layout to prototype to the completed project. Creative Designers could be Graphic Designers, Artists or Photographers. Sigosoft’s creative design include logo design to web designing which comprises the branding. --></p>
						<a class="r-more main-color" href="creative-design.php">Read More</a> 
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							<div class="box-head">
								<i class="icon main-bg fa fa-spinner"></i>
								<h4 class="main-color"><span data-hover="2D/3D Animation">2D/3D Animation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Modern digital marketing methods includes 3D Animation. Our 3D computer animator creates a simplified representation of a character's anatomy, which is analogous to a skeleton or stick figure. The position of each segment of the skeletal model is defined by animation variables or Avars for short.</p>
							<a class="r-more main-color" href="animation.php">Read More</a>
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								<i class="icon main-bg ba"></i>
								<h4 class="main-color"><span data-hover="Corporate Videos">Corporate Videos</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Sigosoft believe corporate videos should deliver results, and that's why we form collaborative partnerships. We build your corporate video on the foundations of what you want to achieve and what you need to express in an engaging way. Through research and experience, rather than guesswork.</p>
							<a class="r-more main-color" href="corporate-videos.php">Read More</a>
						</div>
					</div>
				</div>
