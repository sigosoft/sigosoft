	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 partner-bg">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx white" data-animate="fadeInLeft">Partner With Us<span></span></h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Partner With Us</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class=>Be our partner who are willing to work with us. Work with us as a team will show the combined calibre to attain the growth. </p>
							...
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class=>If you are a personal investor or a team, you can invest in Sigosoft private limited. As we all know our firm is a growing institute. We welcome you with pleasure for being our partner.</p>
							...
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class=>We are leading firm in Calicut, we are ready to accepting strong partnerships with likely minded positive attitude companies. Let's built dreams together.   </p>
			...
			<div class="fun-staff staff-2 block-bg-4 sectionWrapper black-overlay">
					<div class="container">
                      ...
                      <p class="f-20" style="color:#fff;">It takes less than a minute of your time.<br>
Or you may simply call <a href="tel:+919846237384"><i class="fa fa-phone"></i> +91- 9846 23 7384.</a></p>
                        </div>

                         <div class="cell-3">            
                       <a class="btn main-bg ExtraLargeBtn" href="contact.php">Contact Us</a>
                        </div>
