	    ...
	    <div class="pageWrapper">
						    ...
						    <div class="cell-9 top-menu">
							    ...
							    <nav class="top-nav mega-menu">
								    <ul>
								      ...
								      <li class="selected"><a href="#"><i class="fa fa-leaf"></i><span>Shortcodes <b class="menu-hint success">New</b></span></a>
			...
			<div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Testimonials</h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate">/</span><a href="#">Elements </a><span class="line-separate">/</span><span>Testimonials</span>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- TESTIMONIALS STYLE 1 -->
				<div class="sectionWrapper">
					<div class="container">
						<h3 class="block-head">TESTIMONIALS style 1</h3>
				...
				<div class="sectionWrapper gry-bg">
					<div class="container">
						<h3 class="block-head">testimonials style 2</h3>
