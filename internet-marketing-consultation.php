	  ...
	  <!--   <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 internet-marketing-and-consultation">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Internet Marketing Consultation<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
										<i class="imc-small "></i>
									<h4>Internet Marketing Consultation</h4>
									<!-- <div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">Our Internet marketing consultation usually an online digital marketing strategy placed a position of top internet marketing specialists in town. From zero, we start our journey with you till the end we are beside you. We assured client’s online presence. Our hardworking and dedicated team let reach your presence online at its peak. Internet marketing is not such an easy task, by reducing the risk factor we market your brand or product. </p>
				...
				<div class="sectionWrapper img-pattern sahdow">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Why Choose Us ?</h3>
									<p></p>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>Internet marketing have less expense.</li>
										<i class="fa fa-check"></i><li>Competitor analysis with graphical comparison.</li>
										<i class="fa fa-check"></i><li>Direct mailing as well as automated drip campaign connection to workflows.</li>
										<!-- <li></li> -->
									</ul>
								</div>
							</div>
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="Image" src="images/ic.png" class="">
						</div>
					</div>
				</div>
			...
			<div class="sectionWrapper shadow">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							...
							<div class="clearfix"></div>
							<p class="mediumFont">Enterprise Consulting is a professional service and management consulting firm specialized in enterprise software, from optimization, upgrades and improvements in your current software to selection, implementation and integration of new software. </p>
