	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 corparote-website">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Corporate Website<span></span></h1>
				...
				<div class="sectionWrapper img-pattern shadow">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of Corporate Website</h3>
									<p>As a leading corporate web design company, Sigosoft specializes in growing the online presence of companies like yours. Our team includes talented specialists on the cutting edge of corporate website development who are passionate about building business websites from the ground up and tweaking them for optimized results. Best of all, our corporate web development team knows how to keep you ahead of your competition.</p>
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="Image" src="images/cow.png"  alt="a image" title="image">
						</div>
					</div>
				</div>
							...
							<div>
								<div class="portfolio-item">
									<div class="img-holder">
										...
										<img alt="Image" src="images/copweb.jpg">
									</div>
