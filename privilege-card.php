	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
              ...
              <div id="contentWrapper ">
				<div class="page-title title-1 background-product2">
					<div class="container">
						<div class="row ">
							<div class="cell-12  padd-adj center">
								<h1 class="fx white" data-animate="fadeInLeft">Sigo Loyalty App<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									<i class="fa"><img alt="Image" src="images/pci.png" style="margin-top:-7px;"></i>
									<h4>Sigo Loyalty App</h4>
									<br>
									<p class="mediumFont">In today’s competitive marketplace, customer loyalty is crucial to business growth. Loyalty marketing has been around for decades and the advantages (increased customer spending, higher retention, consumer evangelizing, etc.) are well-known – it’s no surprise to find out that nearly every Fortune 500 company has some sort of loyalty marketing program. Digital loyalty programs are now easier to implement and customizable. Using privilege card apps is one of the best ways for small businesses to easily set up a loyalty program to reward long-term customers.</p>
				...
				<div class="sectionWrapper ">
					<div class="container">
							...
							<div class="box-head">
								...
								<h4 >Sigo Loyalty App</h4><br>
							</div>
							<div class="clearfix"></div>
							<p class="hint hintMargin align">Loyality Card is our paramount product. Our Loyality card system consists of a mobile app for customers (Android & iOS) and also web and mobile apps for administrators. Customer apps help users to track their awards points for purchases. In this app users can have a complete overview of available and redeemed points. Existing users can also add new customers by referring them. In admin web app we have provided add customer facility and billing services and in mobile app we have given almost all facilities necessary for an admin to serve a customer.</p>
							<a href="Product-Brochure/Sigo Loyalty card.pdf" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download PDF"></a>
							...
							<img alt="Image" src="images/pc.png">
