...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-113469004-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-113469004-1');
</script>
	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper ">
				<div class="page-title title-1 tech-bg">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx white" data-animate="fadeInLeft">Our Products<span></span></h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Products</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="sectionWrapper">
					<div class="container">
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									<i class="fa fa-check-square-o"></i>
									<h4>Our Products</h4>
									<!-- <div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">Sigosoft is a foremost software development company in calicut, with a wide range of products. We deal with products from diverse fields. Cafe Pos is  a restaurant management ERP application, SigoTex is a cloud based Textile ERP Solution, SigoMarketPlace is a plug and play ecommerce. Privilege card is a loyalty program app .We also develop multi level marketing apps</p>
				...
				<div class="sectionWrapper">
					...
					<div class="container shadow padd-top-25">
						
						<div class="cell-4 service-box-3 fx borders padd-adj hov-2" data-animate="fadeInDown">
							<div class="box-head">
								<!-- <i class="icon main-bg fa fa-apple"></i> -->
								<img src="images/a.png" class="hov">
								<h4 class="main-color"><span data-hover="Sigo Cafe Pos">Sigo Cafe Pos</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="hint hintMargin align">SigoCafePos gives your staff mobility which increases staff efficiency and reducing chances of error. Keeping them armed at all time they are able to take complex order and send them within seconds with the restaurant POS system. Pictures of the menu items can be shown to customers at their tables which will reduce chances of error and save time spent running back and forth between tables. Staff has facility to add and edit customers, as well as products. Sigo CaféPos provides complete history of orders and also cancel the order facility is also available.</p>
							<!-- 	<div class="cell-10" data-animate="fadeInright">
								      <h3 class="block-head">Using Technologies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/html.png"></li>
								      	<li><img src="images/php.png"></li>
								      	<li><img src="images/bs.png"></li>
						...
						<div class="cell-4 service-box-3 fx borders padd-adj hov-2" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<!-- <i class="icon main-bg fa fa-android"></i> -->
								<img src="images/c.png">
								<h4 class="main-color"><span data-hover="Privilage Card">Privilage Card </span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="hint hintMargin align">Privilege Card is our paramount product. Our privilege card system consist of a mobile app for customers (Android & iOS) and also web and mobile apps for administrators. Customer apps helps users to track their awards points for purchases. In this app users can have a complete overview about available and redeemed points. Existing users can also add new customers by referring them. In admin web app we have provided add customer facility and billing services and in mobile app we have given almost all facilities necessary for an admin to serve a customer.
</p>
							<!-- <div class="cell-10" data-animate="fadeInright">
								      <h3 class="block-head">Using Technologies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/html.png"></li>
								      	<li><img src="images/ionic.png"></li>
                            ...
                            <div class="cell-4 service-box-3 fx borders padd-adj hov-2" data-animate="fadeInDown" data-animation-delay="400">
							<div class="box-head">
								<!-- <i class="icon main-bg fa fa-bell"></i> -->
								<img src="images/f.png">
								<h4 class="main-color"><span data-hover="Multi Level Marketing">Multi Level Marketing</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont align">In today’s world everything is dealt with smartphones. Likewise the burden of using MLM Software’s in desktop has been reduced and MLM has been shifted to Mobile apps. Sigosoft PVT LTD provides Multilevel mobile apps in android and iOS with great user experience. No matter how complex your requirement is our mobile app development team is efficient in fulfilling the requirement of every mobile app users. Sigosoft has proven experience in developing mobile apps in unilevel MLM, Binary MLM and Matrix MLM.</p>
								<!-- <div class="cell-10" data-animate="fadeInright">
								      <h3 class="block-head">Using Technologies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/Ast.png"></li>
					...
					<div class="container shadow padd-top-25">
						<div class="cell-4 service-box-3 fx borders padd-adj hov-2" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								<!-- <i class="icon main-bg fa fa-lightbulb-o"></i> -->

								<img src="images/g.png">
								<h4 class="main-color"><span data-hover="Sigo Tex">Sigo Tex</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont align">SigoTex is a cloud based textile ERP Solution. Enterprise resource planning (ERP) software is one of the main tools you will use for managing and leveraging change to sharpen your competitive edge. ERP software needs to be built and implemented to offer agility so you can capitalize on change over time. Sigosoft helps you to meet challenges like globalization, employee engagement, and innovation management. <!-- Our lives are touched daily by the Internet. It widens our horizons and improves our capabilities by connecting us to a wider community and their collective knowledge.  -->
<!-- A similar revolution in industry is connecting intelligent machines and the collective data generated from a growing number of electronic sensors. We are ‘seeing, hearing, and feeling’ our industrial processes like never before and this empowers the decisions we make to optimize performance. --></p>
								<!-- <div class="cell-10" data-animate="fadeInright">
								      <h3 class="block-head">Using Technologies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/rsb.png"></li>
								      	<li><img src="images/php.png"></li>
								     
								      	<li><img src="images/js.png"></li>
								      	<li><img src="images/pyth.png"> </li>
								      </ul>
								  </div>
						...
						<div class="cell-4 service-box-3 fx borders padd-adj hov-2" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Sigo Market Place">Sigo Market Place</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont align">SSigoMarket Place is a plug and play ecommerce. Sigosoft has a team of experienced developers who will help you to Set Up a good Ecommerce business that is promising and profitable. The need for ecommerce solutions are increasing day by day. Sigosoft develop ecommerce site with attractive images and inspiring contents .</p>
								<!-- <div class="cell-10" data-animate="fadeInright">
								      <h3 class="block-head">Using Technologies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/.net.png"></li>
								      	<li><img src="images/had.png"></li>
								      	<li><img src="images/java.png"></li>
			...
			<div class="fun-staff staff-2 block-bg-4 sectionWrapper black-overlay">
					<div class="container">
                      ...
                      <p>It takes less than a minute of your time.<br>
Or you may simply call +91- 98 - 46 23 7384.</p>
                        </div>

                         <div class="cell-3">            
                       <a class="btn main-bg ExtraLargeBtn pop" href="quotess.php">GET A QUOTE</a>
                        </div>
                ...
                <div class=" cd-popup-inner-container career-frm-cnr width">
                	...
                	<div class="contact-form">
					    			<form action="#" id="hire_form">
				    					...
				    					<div class="form-input">
				    						<label>Services Required<span class="red">*</span></label>
				   						<select required>
				    							<option value=""> Website</option>
				    							<option> Andriod Application</option>
				    					...
				    					<div class="form-input">
				    						<label>About Product<span class="red">*</span></label>
