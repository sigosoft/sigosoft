...
<script>
  ...
  gtag('config', 'UA-113469004-1');
	...
	<body>
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 social-media">
					<div class="container text-center">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Social media marketing <span></span></h1>
						...
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of SMM</h3>
								<!-- 	<p>SEO and SMO are two terms have gotten very popular these days. The terms are mainly used in context for webmasters and bloggers. Both, SEO and SMO are utilized to increase traffic to a website. However, SEO and SMO are quite different than each other and utilize different techniques to achieve their means. There are many webmasters who claim expertise in SEO and/or SMO. Their main responsibility is to increase the number of visitors to a particular website.</p> -->
									<ul class="list prim list-ok">
										<li class="fa fa-check">Increasing the customer interaction by evaluating it.</li><br>
										<li class="fa fa-check">Awareness of your brand could be done.</li><br>
										<li class="fa fa-check">Make you to engage with your own customers</li><br>
										<li class="fa fa-check">Expertise your sector is highly possible</li>
									</ul> <br>
									<a href="Product-Brochure/Digital Marketing.pdf" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download PDF"></a>
								</div>
							</div>
						</div>
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="Image" src="images/smm.png" class="radius">
						</div>
					</div>
				</div>
    ...
    image.src = "images/smmi-hover.png"; //Blue Image
  }
  function unhighlight(image) {
    image.src = "images/smmi.png"; //Gray Image
  }
</script>
				 </script>
	</body>
