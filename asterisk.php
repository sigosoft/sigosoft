						...
						<div class="row">
							...
							<div class="cell-4 fx" data-animate="flipInX">
								<div class="padd-top-25 center">
									<img alt="imageis loading" src="images/asterisk.png">
								</div>
							</div>
								<div class="cell-8">
								...
								<div class="fx" data-animate="fadeInLeft">
									<h3 class="block-head">Asetrisk</h3>
									...
									<ul class="list alt list-ok">
										<li class="fx" data-animate="fadeInLeft">The Asterisk software includes many features available in commercial and proprietary PBX systems: voice mail, conference calling and automatic call distribution</li>
										<li class="fx" data-animate="fadeInLeft" data-animation-delay="200">Asterisk supports several standard voice over IP protocols, including SIP,MGCP and H.323</li>
										<li class="fx" data-animate="fadeInLeft" data-animation-delay="400">In addition to VoIP protocols, Asterisk supports traditional circuit-switching protocols such as ISDN and SS7</li>
									</ul>
								</div>
...
<div class="sectionWrapper">
					<div class="container">
						<div class="row">
								...
								<div class="cell-12" data-animate="fadeInright">
								      <h3 class="block-head">Using Technolagies</h3>
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img alt="imageis loading" src="images/html.png"></li>
								      	<li><img  alt="imageis loading" src="images/css.png"></li>
								      	<li><img  alt="imageis loading" src="images/bs.png"></li>
								      	<li><img  alt="imageis loading" src="images/js.png"></li>
								      	<li><img  alt="imageis loading" src="images/jquery.png"> </li>
								      	<li><img  alt="imageis loading" src="images/php.png"> </li>
								      	<li><img  alt="imageis loading" src="images/laravel.png"> </li>
								      	<li><img  alt="imageis loading" src="images/ajax.png"> </li>
								      		<li><img  alt="imageis loading" src="images/codelgniter.png"> </li>
								      </ul>
								  </div>
