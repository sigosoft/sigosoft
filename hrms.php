             ...
             <div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">HRMS<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class="mediumFont">HRMS are most common everywhere, but why we differ from others ? our HRMS provides a means of acquiring, storing, analyzing and distributing information to various stakeholders. HRMS enable improvement in traditional processes and enhance strategic decision-making.Sigosoft’s HRMS is user friendily with reduced human effort and attractive UI. Our Human Resource Management Software and Solution is flexible and scalable, and is designed to grow with you. Unlike other HR Software providers, our HRM Solution can be customized to suit your needs</p>
				...
				<div class="sectionWrapper img-pattern">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									...
									<p>Our Human Resources System typically provide the following features



</p>
									<ul class="list prim list-ok">
										<li>HRMS Is 100% Secured</li>
										<li>HRMS Management consultation, system configuration, training & rollout</li>
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="" src="images/HRMS.png" class="">
						</div>
					</div>
				</div>
