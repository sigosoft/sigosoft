...
<meta name="description" content="Sigosoft Private Limited is a leading software development company in Calicut, Kerala. We are mainly focusing on Digital Marketing, Web Development, App Development and IT Consultation. We have strong background in E-commerce development and in Mobile App development." />
		<meta name="author" content="Software development">
						...
						<div class="row">
							<div class="cell-8">
								...
								<div class="fx" data-animate="fadeInLeft">
									<h3 class="block-head">Internet Of things</h3>
									<p class="hint hintMargin">Here you can write a small description for this block and tell us more about it.</p>
									<p>internet of Things are just hardware pieces at the initial stage. They are brought to life when they are wirelessly connected over a mobile or web application. Then you could automate things. Switch on the lights in your home or office, monitor the washing machine, check the availability of water, cook food within no time, and much more.
We at sigosoft design, build, and release world class apps connecting Internet of Things ensuring the best level of user experience from all corners.
</p>
									<ul class="list alt list-ok">
										<li class="fx" data-animate="fadeInLeft">The value of the IoT is not technolog</li>
										<li class="fx" data-animate="fadeInLeft" data-animation-delay="200">Businesses outside of your industry may know something you don’t</li>
										<li class="fx" data-animate="fadeInLeft" data-animation-delay="400">Push more intelligence to the edge</li>
							...
							<div class="cell-4 fx" data-animate="flipInX">
								<div class="padd-top-25 center">
									<img alt="image" src="images/internet.jpeg">
								</div>
							</div>
					...
					<div class="container">
						<div class="row">
								...
								<div class="cell-10" data-animate="fadeInright">
								      ...
								      <div class="cell-10">
								      <ul class="tech">
								      	<li><img src="images/html.png" alt="Image"></li>
								      	<li><img src="images/css.png" alt="Image"></li>
								      	<li><img src="images/bs.png" alt="Image"></li>
								      	<li><img src="images/js.png" alt="Image"></li>
								      	<li><img src="images/jquery.png" alt="Image"> </li>
								      </ul>
								  </div>
