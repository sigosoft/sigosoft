	...
	<body>
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 creative-designing">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Creative Designing <span></span></h1>
						...
						<div class="row">
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class="mediumFont">Our creative Graphic design is the art and practice of planning and projecting ideas and experiences with visual and textual content. Our graphic designs are accepted widely by our clients and their customers. We can assure you highly appealing designs. The work can happen at any scale, from the design of a single postage stamp to a national postal signage system. </p>
							...
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown" data-animation-delay="200">
								<div class="box-2-cont">
									...
									<p class="mediumFont">Our Web designing is superlative, it's not our word, our customer's affirmation is that we are simply exquisite. It encompasses several different aspects, including webpage layout from Photoshop, first-rate content writing, and graphic design. While the terms web design and web development are often used interchangeably, web design is technically a subset of the broader category of web development.</p>
									<!-- <a class="r-more main-color" href="#">Read More</a> -->
								</div>
							</div>
							<div class="cell-4 service-box-2 fx" data-animate="fadeInDown" data-animation-delay="200">
								<div class="box-2-cont">
									...
									<p class="mediumFont">As we know, a logo is a graphic mark or emblem commonly used by commercial enterprises, organizations or even individuals to aid and promote instant public recognition. Sigosoft Pvt Ltd makes a unique brand identity to your firm by initially developing a suit logo. A logo’s job is to quickly and succinctly identify, symbolize, introduce, and tell the story of a company, service, product, individual or idea.</p>
									<!-- <a class="r-more main-color" href="#">Read More</a> -->
								</div>
							</div>
				...
				<div class="sectionWrapper img-pattern">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Creative Designing</h3>
									<p>Our Creative Design works in areas of Branding, identity creation to various entities such as product labels or brochures, that provide information about a company’s offerings and services. We design these materials using paper sketches and digital illustration software. We will follow the process from concept to rough layout to prototype to the completed project. Creative Designers could be Graphic Designers, Artists or Photographers. Sigosoft’s creative design include logo design to web designing which comprises the branding.</p>
						...
						<div class="cell-4 fx " data-animate="bounceIn">
							<img  alt="a image" title="image" src="images/cd.png" class="radius" >
						</div>
					</div>
				</div>
				...
				<div class="sectionWrapper gry-pattern">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							...
							<div class="clearfix"></div>
							<p class="mediumFont">We believe corporate videos should deliver results, and that's why we form collaborative partnerships. We build your corporate video on the foundations of what you want to achieve and what you need to express in an engaging way. Through research and experience, rather than guesswork.</p>
