	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 voip">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">VOIP<span></span></h1>
						...
						<div class="cell-6">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of VoIP</h3>
									<p>Our VoIP services typically provide the following Scope.</p>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>Interactive voice recognition. Your customers can have a spoken menu to direct them to the appropriate line.</li><br>
										<i class="fa fa-check"></i><li>Automatic call distribution. Once a call arrives, it is automatically channelled to the right department, or to ring multiple phones.</li><br>
										<i class="fa fa-check"></i><li>Voicemail to email. Voicemail is transcript into an email and sent to you.</li>
										<i class="fa fa-check"></i><li>Conferencing and Do not disturb.</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="cell-6 fx" data-animate="bounceIn">
							<img alt="Image" src="images/voip.png" class="">
						</div>
					</div>
				</div>
			...
			<div class="sectionWrapper">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa pwi"></i>
								<h4 class="main-color"><span data-hover="Personal Website">Personal Website</span></h4>
							</div>
							<div class="clearfix"></div>
						...
						<a class="r-more main-color" href="personal-websites.php">Read More</a> 
						</div>
