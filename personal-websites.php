	...
	<body>
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 personal-website">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Personal Website<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class="mediumFont">We are experts in personal website design. Celebrities, models, VIP, students etc. could have needed a personal website very must. For showing CV, portfolio and other works everyone needs the online presence. Many personal pages only include information of interest to friends and family of the author. Sigosoft consult your personal branding needs successfully.</p>
				...
				<div class="sectionWrapper img-pattern shadow">
					<div class="container">
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of Personal Website</h3>
									<p>Personal web pages contain content of a personal nature rather than the content concern to a company, organization or institution. Personal web pages are primarily used for informative or entertainment purposes but can also be used for the personal career, social networking with other people with shared interests, or as a space for personal expression. In strictly technical terms, a site's actual homepage often only contains sparse content with some catchy introductory material and serves mostly as a pointer or table of contents to the more content-rich pages inside, online journals and diaries or other writing, examples of written work, digital audio sound clips, digital video clips, digital photos, or information about a user's other interests.</p>
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="image" src="images/pw.png" class="">
						</div>
					</div>
				</div>
				...
				<div class="sectionWrapper">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								<i class="icon main-b ecw"></i>
								<h4 class="main-color"><span data-hover="E-commerce Website">E-commerce Website</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">High –end applications have end-to-end technology solutions to various enterprises. Our development team helps the client to build the application from scratch and made them finished within a short span of time. We are master in ecommerce appliacations, and extremely honoured by clients business growth through online. <!-- Being one of the leading SMM Company in Calicut, Sigosoft realise the importance of such connections. Our ultimate aim is to use social media marketing in an effective manner take advantage of the many benefits that come with it. --></p>
							<a class="r-more main-color" href="ecommerce-providers.php">Read More</a>
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa fa-desktop"></i>
								<h4 class="main-color"><span data-hover="Corporate Website">Corporate Website</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">We are experts in personal website design. Celebrities, models, VIP, students etc. could have needed a personal website very must. For showing CV, portfolio and other works everyone needs the online presence. Many personal pages only include information of interest to friends and family of the author.  <!-- We will follow the process from concept to rough layout to prototype to the completed project. Creative Designers could be Graphic Designers, Artists or Photographers. Sigosoft’s creative design include logo design to web designing which comprises the branding. --></p>
						<a class="r-more main-color" href="corporate-websites.php">Read More</a> 
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							<div class="box-head">
								<i class="icon main-bg fa fa-support"></i>
								<h4 class="main-color"><span data-hover="CMS">CMS</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Content Management System Content management system has WordPress is a Content Management System that allows you to create and publish your content on the web. A blog is a content management system. We are prominent in cms. A CMS software that opens the door for creating, editing, organizing, and publishing content. </p>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								<i class="icon main-bg fa fa-phone "></i>
								<h4 class="main-color"><span data-hover="VoIP">VoIP</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">A technology that allows users to communicate through an Internet connection rather than an analogue connection. Voice-over-Internet Protocol converts the voice signal associated with traditional phone technology into a digital signal. We had done VoIP projects that’s a golden feather in our journey.</p>
