	...
	<body>
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 web-hosting-and-consultation">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Web Hosting Consultation<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<h4>Web Hosting Consultation</h4>
									<!-- <div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">We provide web hosting consultation. Web hosting service that allocates to host a website on the Internet. There are several Web hosting service providers all over. To choose one of the best from them and choose the best package is not an easy task. According to client’s usage analysis and requirement, we would help you to choose best package and service provider. Things to beware before select hosting is speed and customer support.</p>
						...
						<div class="cell-7">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of Web Hosting Consultation</h3>
									<h5>Our Web hosting services typically provide the following features.</h5>
									<ul class="list prim list-ok">
										<li class="fa fa-check">No Hidden Cost, No Setup fee & No Extra Payments.</li>
										</i><li class="fa fa-check">Our best web hosting plans support CMS like WordPress, Joomla, Drupal, Magento etc.</li>
										<li class="fa fa-check">Instant support via Telephone, Chat and email tickets.</li>
										<li class="fa fa-check">With the latest Technology, we can give a guarantee of 99.9% uptime.</li>
										<li class="fa fa-check">Custom hosting plans according to the clients requirements.</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="cell-5 fx" data-animate="bounceIn">
							<img alt="Image" src="images/hos.png" class="">
						</div>
					</div>
				</div>
				...
				<div class="sectionWrapper shadow">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa fa-arrows"></i>
								<h4 class="main-color"><span data-hover="Start Up Consultation">Start Up Consultation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Our start up consultation provides business owners with resources, advice and planning designed to improve an organization’s performance and efficiency. To start a venture, there needs detailed consultation and effective ways to utilise their finance.<!-- We will follow the process from concept to rough layout to prototype to the completed project. Creative Designers could be Graphic Designers, Artists or Photographers. Sigosoft’s creative design include logo design to web designing which comprises the branding. --></p>
						<a class="r-more main-color" href="startup-consultation.php">Read More</a> 
						</div>
