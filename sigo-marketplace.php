	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
              ...
              <div id="contentWrapper ">
				<div class="page-title title-1 background-product5">
					<div class="container">
						<div class="row ">
							<div class="cell-12  padd-adj center">
								<h1 class="fx white" data-animate="fadeInLeft">Sigo Market Place<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									<i class="fa"><img alt="Image" src="images/eci.png"  style="margin-top:-7px;"></i>
									<h4>Sigo Market Place</h4>
									<br>
									<p class="mediumFont align">SigoMarket Place is a plug and play ecommerce. Sigosoft has a team of experienced developers who will help you to Set Up a good Ecommerce business that is promising and profitable. The need for ecommerce solutions are increasing day by day. Sigosoft develop ecommerce site with attractive images and inspiring contents .</p>
                           ...
                           <div class="cell-6">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<!-- <h3 class="block-head">Scope Of HRMS</h3> -->
									<h5>Sigo Market Place typically provide the following features</h5>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>   We’ll create a completely functional ecommerce strategy that fits your brand perfectly. We use search marketing and online advertising to promote the site.</li>
										<i class="fa fa-check"></i><li>  We Build ecommerce website that utilise the features and functionalities of frame work in the greatest extend.</li>
										<i class="fa fa-check"></i><li>  We develop an impressively interactive at the same time easy to navigate user interface that enables easy access.</li>
										<!-- <li> Cart : Allowing </li>
										<i class="fa fa-check"></i><li>Registration : Allow adding new users to the Mobile app.</li>
										<i class="fa fa-check"></i><li> Tree : Displays complete users from parent to child. </li>
										<i class="fa fa-check"></i><li>  Profiles : Shows the user information.</li>
										 <i class="fa fa-check"></i><li>Password Settings :  Allows to change the password.</li> -->
									</ul><br>
									<a href="Product-Brochure/e-commerce.pdf" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download PDF"></a>
								</div>
							</div>
						</div>
							...
							<img alt="Image" src="images/smc.png">
