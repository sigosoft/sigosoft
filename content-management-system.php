	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 cms">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Content Management System<span></span></h1>
				...
				<div class="sectionWrapper img-pattern shadow">
					<div class="container">
						<div class="cell-6">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Scope Of CMS</h3>
									<p>Content management systems typically provide the following features</p>
									 <ul class="list prim list-ok">
										<li class="fa fa-check">SEO-friendly URLs.</li><br>
										<li class="fa fa-check">Integrated and online help.</li><br>
										<li class="fa fa-check">Modularity and extensibility.</li><br>
										<li class="fa fa-check">User and group functionality.</li><br>
										<li class="fa fa-check">Install and upgrade wizards.</li><br>
										<li class="fa fa-check">Templating support for changing designs.</li>
						...
						<div class="cell-6 fx" data-animate="bounceIn">
							<img alt=" a image" src="images/cms.png" title="image">
						</div>
					</div>
				</div>
