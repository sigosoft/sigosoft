	  ...
	  <!--   <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 cross-platform">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Cross Platform<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								...
								<!-- 	<div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">Cross-platform mobile development refers to the development of mobile apps that can be used on multiple mobile platforms. Multi-platform mobile application development provides the user experience and functionality of native apps with the multi-platform compatibility of mobile web apps. We deliver apps for multi-platforms by writing code once and making it work on iOS, Android  platforms. With an experience of developing cross-platform mobile apps for a wide range of mobile devices and platforms, we offer services to build apps that are coded once and runs on multiple mobile platforms, helping clients to get an app developed in reduced cost and timeline.</p>
						...
						<div class="cell-7">
							<div class="row"> 
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Our Cross Platform Services</h3>
									<p></p>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>We understand market requirements and designs the right mobile strategy for businesses.</li>
										<i class="fa fa-check"></i><li>Beautiful, usable, real-world apps.</li>
										<i class="fa fa-check"></i><li>Better user experience in terms of functionality, improved usability and interactive designs.</li>
										<i class="fa fa-check"></i><li>Great performance with super-fast response times.</li>
										<i class="fa fa-check"></i><li>Post development support through your preferred communication medium.</li>
										<i class="fa fa-check"></i><li>Better communication and quick turnaround times.</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="cell-5 fx" data-animate="bounceIn">
							<img  alt="a image" title="image" src="images/cross.png" >
						</div>
					</div>
				</div>
			...
			<div class="sectionWrapper">
					<div class="container">
						...
						<div class="cell-6 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								<i class="icon main-bg fa fa-android"></i>
								<h4 class="main-color"><span data-hover="Android Application">Android Application</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">The open-source mobile operating system based on the Linux kernel developed by Google. It has the largest installed base of all OS of any kind. We build B2B & B2C applications that comprise the most recent technology with high-technology feature and creative and effective widgets. Intuitive designs combined with forcible user interaction are what makes apps stand ahead in the digital age. Our team has built applications that deals with web services integration, push messaging, social network integration, real-time navigation and user interaction, Maps & Locations, background processing, Camera & Photo Library and it goes on.</p>
							<a class="r-more main-color" href="android-apps.php">Read More</a>
						</div>
						<div class="cell-6 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa fa-apple"></i>
								<h4 class="main-color"><span data-hover="ios Application">ios Application</span></h4>
</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Mobile operating system created and developed by Apple, used exclusively for Apple hardware. Objective-C and Swift programming languages are used for iOS development. We analyse your business requirements in details and develop specific application matching up with your idea and requirement. We have developed many iOS apps for companies that are focused towards businesses needs and for the mass market. We have an expert team of mobile app development professionals specializing in iOS app design and development. Developing smooth, reliable, scalable and apps of high security within the specified timeline, ensuring 100% customer satisfaction is our word to the clients.</p>
						<a class="r-more main-color" href="ios-apps.php">Read More</a> 
						</div>
