	  ...
	  <!--   <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 startup-consultation">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Start up Consultation<span></span></h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Services</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<h4>Start up Consultation</h4>
									<!-- <div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">Our start up consultation provides business owners with resources, advice and planning designed to improve an organization’s performance and efficiency. To start a venture, there needs detailed consultation and effective ways to utilise their finance. They are contracted employees that help businesses identify problems, implement solutions, and reach goals. We boost your tech start-up with highly scalable IT teams and services, proven cross-border experience and knowledge retention. Our services are tuned for start-up companies, made by entrepreneurs for entrepreneurs. Helps clients to create success by focusing on personal development: time management, self-sabotaging behaviour, finding clarity, decision making. Sigosoft's  start up consultation paved the way for many start ups to begin their journey with power confidence.</p>
						...
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Why shoud Choose Us ?</h3>
									<p></p>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>Set up their operations and systems.</li>
										<i class="fa fa-check"></i><li>Start with their own skill-building.</li>
										<i class="fa fa-check"></i><li>Building  brand; web, mobile, and social presence.</li>
										<i class="fa fa-check"></i><li>Help recruit the right talent.</li>
										<i class="fa fa-check"></i><li>We treat a start up as a customer, not a client.</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="" src="images/cons.png" class="">
						</div>
					</div>
				</div>
				...
				<!-- <div class="sectionWrapper">
							...
							<div>
								<div class="portfolio-item">
									<div class="img-holder">
										...
										<img alt="" src="images/personal.png">
									</div>
							...
							<div>
								<div class="portfolio-item">
									<div class="img-holder">
										...
										<img alt="Image" src="images/personal.png">
									</div>
									<div class="name-holder">
											<a href="#" class="project-name">Project Title</a>
											<span class="project-options">Project Category</span>
					...
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								<i class="icon imc-big"></i>
								<h4 class="main-color"><span data-hover="Internet Marketing Consultation">Internet Marketing Consultation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">ur Internet marketing consultation usually an online digital marketing strategy placed a position of top internet marketing specialists in town. From zero, we start our journey with you till the end we are beside you. We assured client’s online presence.  <!-- Being one of the leading SMM Company in Calicut, Sigosoft realise the importance of such connections. Our ultimate aim is to use social media marketing in an effective manner take advantage of the many benefits that come with it. --></p>
							<a class="r-more main-color" href="internet-marketing-consultation.php">Read More</a>
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								<i class="icon main-bg fa fa-cloud"></i>
								<h4 class="main-color"><span data-hover="Web Hosting">Web Hosting</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">We provide web hosting consultation. Web hosting service that allocates to host a website on the Internet. There are several Web hosting service providers all over. To choose one of the best from them and choose the best package is not an easy task. <!-- We will follow the process from concept to rough layout to prototype to the completed project. Creative Designers could be Graphic Designers, Artists or Photographers. Sigosoft’s creative design include logo design to web designing which comprises the branding. --></p>
						<a class="r-more main-color" href="web-hosting.php">Read More</a> 
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							<div class="box-head">
								<i class="icon ec-white"></i>
								<h4 class="main-color"><span data-hover="Enterprise Consultation">Enterprise Consultation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Enterprise Consulting is a professional service and management consulting firm specializing in enterprise software, from optimization, upgrades and improvements in your current software to selection, implementation and integration of new software. </p>
							<a class="r-more main-color" href="enterprise-consultation.php">Read More</a>
						</div>
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								<i class="icon main-bg fa fa-lock "></i>
								<h4 class="main-color"><span data-hover="Security Consultation">Security Consultation</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Our job is to take the burden out of planning, designing and implementing security systems and all the associated technology and processes. Devices, apps and the cloud are basically changing the way we work – and the way we need to think about online threats.</p>
							<a class="r-more main-color" href="security-consultation.php">Read More</a>
						</div>
					</div>
