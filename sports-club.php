	   ...
	   <!--  <div class="page-loader">
	    ...
	    <!-- site preloader end -->
              ...
              <div id="contentWrapper ">
				<div class="page-title title-1 background-product4">
					<div class="container">
						<div class="row ">
							<div class="cell-12  padd-adj center">
								<h1 class="fx white" data-animate="fadeInLeft">Sigo Sports Club Management<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<h4>Sigo Sports Club Management</h4>
									<br>
									<h5 class="mediumFont">The sports club management system software is a built system that manages the entire club activities and provides respective functionality for various types of visitors.The growth of Fitness business every year is 20% than the previous year.A Mobile App for Health is being a must needed for everyone now.This system is built with respect to managing a club. It allows manage for club membership, enroll for various activities and other services offered at premises. The sports club management system is built keeping in mind various daily activities of an establishment and the software automates all these club functionality for easy operation of the club</h5>
				...
				<div class="sectionWrapper ">
					<div class="container">
                           ...
                           <div class="cell-6">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									...
									<ul class="list prim list-ok">
										...
										<i class="fa fa-check"></i><li> This system will save you countless hours associated with the labor intensive, time-consuming tasks associated with running your establishment.</li>
										<i class="fa fa-check"></i><li> The system is web based and we offer it as a service.</li>
										<i class="fa fa-check"></i><li> This means that you do not need to buy expensive equipment or software. Better yet, there is no software to install.</li>
										<i class="fa fa-check"></i><li> All you need to use our service is your club's website.</li>
										<i class="fa fa-check"></i><li> Easy to enter and maintain information about your patrons. 
</li>
										<i class="fa fa-check"></i><li> Billing, schedule, communications, player attendance as well as all other custom features can be provided by our system.</li>
										<i class="fa fa-check"></i><li> Web based service offers remote access even when your are not within premises</li>
										
									</ul><br>
									<a href="Product-Brochure/Sigo Sports Club Management System.pdf" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download PDF"></a>
									<a href="download.php" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="Download APK"></a>
									<a href="http://ourworks.today/cosmosestadio/admin/" target="_blank" ><input type="submit" name="submit" class="btn btn-large main-bg" value="ADMIN LOGIN"></a>
							...
							<img alt="Image" src="images/tex.jpg">
