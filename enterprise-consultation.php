	  ...
	  <!--   <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 corparote-enterprise">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Enterprise Consultation<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<p class="mediumFont"> Enterprise Consulting is a professional service and management consulting firm specialized in enterprise software, from optimization, upgrades and improvements in your current software to selection, implementation and integration of new software. Our Consultants provides business owners with resources on various technological needs, we serve towards helping professionals to cross business obstacles. We provide the experience and skills that business owners need and also, we deliver answers to questions that business owners can’t solve on their own.</p>
						...
						<div class="cell-6">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Our Enterprise Services</h3>
									...
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>ERP Implementations</li>
										<i class="fa fa-check"></i><li>ERP Upgrades</li>
										<i class="fa fa-check"></i><li>Business Process Improvement</li>
										<i class="fa fa-check"></i><li>Process Review</li>
										<i class="fa fa-check"></i><li>Addovation</li>
										<i class="fa fa-check"></i><li>Application Integration</li>
										<i class="fa fa-check"></i><li>Enterprise Software Selection</li>
										<i class="fa fa-check"></i><li>ERP Project Management</li>
										<i class="fa fa-check"></i><li>Business Intelligence</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="cell-6 fx" data-animate="bounceIn">
							<img alt="A image " src="images/entreprice.png" class="" title="a image">
						</div>
					</div>
				</div>
				...
				<div class="sectionWrapper shadow">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							...
							<div class="clearfix"></div>
							<p class="mediumFont">Our Internet marketing consultation usually an online digital marketing strategy placed a position of top internet marketing specialists in town. From zero, we start our journey with you till the end we are beside you. We assured client’s online presence. </p>
