             ...
             <div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Logo Designing<span></span></h1>
						...
						<div class="row">
							<div class="cell-6 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<h4>Iconic/Symbolic</h4>
									
									<p class="mediumFont">Logo design is classified into many types, the core one is icons/symbols. Icons and symbols are part of our every day life  since the beginning of civilization. In ancient period Communication is based on symbols and drawings. Cave paintings tell the story of the hunt, sign language and hand gestures communicate without words. painting, sculpture and photography tell stories and express meaning and emotion too complex for words .Each galaxies has its own symbol. commerce and advances in physics,engineering,and the sciences etc uses international signs and icons.</p>
							...
							<div class="cell-6 service-box-2 fx" data-animate="fadeInDown" data-animation-delay="200">
								<div class="box-2-cont">
									...
									<h4>Logotype/Wordmark</h4>
									
									<p class="mediumFont">Whether a graphic is a standalone symbol of a company or part of a logo using type, it tells a story, has a tone and feel, conveys emotion and can carry a history. Many of the symbols shown here are part of our collective visual vocabulary. They have conscious and subconscious meanings and associations for each of us. With both well-researched and intuitive awareness of the meaning, colour and style of a symbol or graphic to precisely mould a consumer’s experience, creating, contributing to, or informing their perception of the company.we can develop logotypes/ wordmark which is also very catching and attractive.</p>
						...
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head"> logo designing </h3>
									<p>As we know, a logo is a graphic mark or emblem commonly used by commercial enterprises, organizations or even individuals to aid and promote instant public recognition. Sigosoft makes a unique brand identity to your firm by initially developing a suit logo. A logo’s job is to quickly and succinctly identify, symbolize, introduce, and tell the story of a company, service, product, individual or idea. Branding starts from logo creation. Brand is used here in its earliest definition—”an identifying mark made by hot iron”—an ancient way to identify property. We creates logo which have both inner meaning and visually appealing beauty.</p>
									
								</div>
							</div>
						</div>
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="" src="images/logo-design.jpg" class="radius">
						</div>
					</div>
				</div>
					...
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Attractive">Print & Media</span></h4>
							</div>
							<div class="clearfix"></div>
