             ...
             <div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">On Job Training<span></span></h1>
								<div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
									<span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate"></span><span class="line-separate">/</span><span>Training</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="sectionWrapper img-pattern">
					<div class="container">
						...
						<div class="cell-4 fx" data-animate="bounceIn">
							<img alt="" src="images/ojt.png" class="">
						</div>
					</div>
				</div>
					...
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Attractive">Ios App</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="200">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Effective">Cross platform</span></h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="600">
							<div class="box-head">
								...
								<h4 class="main-color"><span data-hover="Professional"></span>Logo Designing</h4>
							</div>
							<div class="clearfix"></div>
							<p class="mediumFont">Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
							<a class="r-more main-color" href="#">Read More</a>
