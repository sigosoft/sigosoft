	  ...
	  <!--   <div class="page-loader">
	    ...
	    <!-- site preloader end -->
             ...
             <div id="contentWrapper">
				<div class="page-title title-1 branding-consultation">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft">Branding Consultation<span></span></h1>
						...
						<div class="row">
							<div class="cell-12 service-box-2 fx" data-animate="fadeInDown">
								<div class="box-2-cont">
									...
									<h4>Branding Consultation</h4>
									<!-- <div class="center sub-title main-color">sub title</div> -->
									<p class="mediumFont">Branding aims to establish a significant and differentiated presence in the market that attracts and retains loyal customer’s Sigosoft is one of the leading precognition brands which helps to create the future for your brand and business. Our team of consultants provide simple and cost-effective business boost to small-scale and upcoming organisation caring about making an identity for each brand. We managed to build up a team of talented professionals who are ready to assist you when you are in a hindrance.</p>
				...
				<div class="sectionWrapper img-pattern shadow">
					<div class="container">
						<div class="cell-7">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Our Branding Services</h3>
									<p></p>
									<ul class="list prim list-ok">
										<i class="fa fa-check"></i><li>Business Analysis.</li>
										<i class="fa fa-check"></i><li>Brand Strategy.</li>
										<i class="fa fa-check"></i><li>Brand Health Audit.</li>
										<i class="fa fa-check"></i><li>Brand  Cloning Training.</li>
										<i class="fa fa-check"></i><li>Business Diversification.</li>
										<i class="fa fa-check"></i><li>Consumer Acquisition.</li>
										<i class="fa fa-check"></i><li>Product Positioning.</li>
						...
						<div class="cell-5 fx" data-animate="bounceIn">
							<img alt=" a image" src="images/bc.png" title="Business consultation">
						</div>
					</div>
				</div>
							...
							<div>
								<div class="portfolio-item">
									<div class="img-holder">
										...
										<img alt="a image" src="images/personal.png">
									</div>
			...
			<div class="sectionWrapper shadow">
					<div class="container">
						...
						<div class="cell-3 service-box-3 fx" data-animate="fadeInDown" data-animation-delay="400">
							...
							<div class="clearfix"></div>
							<p class="mediumFont">MEnterprise Consulting is a professional service and management consulting firm specializing in enterprise software, from optimization, upgrades and improvements in your current software to selection, implementation and integration of new software. </p>
